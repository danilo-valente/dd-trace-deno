...
addHook({ name: 'net' }, (net: { Socket: { prototype: any } }) => {
  shimmer.wrap(
    net.Socket.prototype,
    'connect',
    (connect: { apply: (arg0: any, arg1: IArguments) => any }) =>
      function () {
...
function getOptions(args: IArguments | any[]) {
  if (!args[0]) return;
...
function setupListeners(
  socket: { removeListener: (arg0: string, arg1: () => void) => void; once: (arg0: string, arg1: () => void) => void },
  protocol: string,
  asyncResource: { bind: (arg0: { (error: any): void; (): void }) => any },
) {
