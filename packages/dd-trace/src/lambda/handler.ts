 ...
 */
function checkTimeout(context: { getRemainingTimeInMillis: () => any }) {
  const remainingTimeInMillis = context.getRemainingTimeInMillis();

  let apmFlushDeadline = parseInt(Deno.env.get('DD_APM_FLUSH_DEADLINE_MILLISECONDS')) || 100;
 ...
 */
function extractContext(args: string | any[]) {
 ...
 */
exports.datadog = function datadog(lambdaHandler: { apply: (arg0: any, arg1: any[]) => any }) {
